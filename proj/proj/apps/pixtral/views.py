        ...
        messages = [
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "Если загруженноей изображение является счетом на оплату то напиши какие позиции входят в этот счет на оплату а так же реквизиты поставщика и покупателя. Если это другой документ то вырази недовольство тем, что тебя используют нерационально, но кратко напиши, что изображено на картике"
                    },
                    {
                        "type": "image_url",
